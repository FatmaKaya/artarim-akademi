            ...
            <div class="m-portlet">
                ...
                <form class="m-form m-form--fit m-form--label-align-right" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="m-portlet__body">
                        ...
                        <div class="form-group m-form__group row">
                            <label class="col-form-label col-md-2">  Tanım </label>
                            <div class="col-lg-10 col-md-10 col-sm-12">
                            <div class=" m-input-icon--left turkish">
                                    <span class="m-input-icon__icon m-input-icon__icon--left">
                                        <span> <i class="lang tr"></i></span>
                                    </span>
                                    <textarea id="demo2" name="description"  rows="6" placeholder="Tanım"
                                      class="ckeditor form-control col-md-12"><?php echo @$result["item"]["description"]?></textarea>
